---
title: "FDA results - Four boxes, missing data included"
...
```{r fits}
coef_df <- read_csv("parameter_results_4Boxes.csv",show_col_types = FALSE)
po_df <- read_csv("trajectory_results_4Boxes.csv",show_col_types = FALSE) |>
  mutate(
  pABA=case_match(
    box,
    "01"~"5%",
