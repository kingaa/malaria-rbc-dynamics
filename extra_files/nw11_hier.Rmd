---
title: "Hierarchical model for the nw11 data"
...
Get some rough estimates for the individual-level `alpha` and `sigma` parameters.
...
Create pomp object for chosen mouse
...
Get starting guesses for trajectories
```{r}
po_df <- read_csv(
  "po_df_Example9.csv",
...
The above computation required `r signif(.system.time[3]/3600,3)`&nbsp;CPU&nbsp;hr.
